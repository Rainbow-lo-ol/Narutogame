...
namespace Naruto_game
{
    public class Battle4
    {
        ...
        public Hero Shikamaru;
        public Villian Tayuya;
        ...
        public void Draw()
        {
            if (GamePlay.IsBattle4 && !GamePlay.IsBreak)
            {
                Shikamaru.Draw();
                Tayuya.Draw();
